...
namespace Tinyman.V1
{
    ...
    public class TinymanClient
    {
        ...
        public readonly IDefaultApi mDefaultApi;
        public readonly Algorand.V2.Indexer.LookupApi lookupApi;
        ...
        public TinymanClient(
            IDefaultApi defaultApi,
            Algorand.V2.Indexer.LookupApi lookupApi,
        ...
        public virtual async Task<Pool> FetchPoolAsync(Asset asset1, Asset asset2)
        {
            ...
            var accountInfo = await lookupApi.AccountsAsync(poolAddress, null, null);

            return await CreatePoolFromAccountInfoAsync(accountInfo.Account, asset1, asset2);
        }
        ...
        public virtual async Task<Pool> FetchPoolAsync(string poolAddress)
        {
            ...
            return await CreatePoolFromAccountInfoAsync(accountInfo.Account);
        }
        ...
        protected virtual async Task<Pool> CreatePoolFromAccountInfoAsync(Algorand.V2.Indexer.Model.Account accountInfo)
        {
        ...
        protected virtual async Task<Pool> CreatePoolFromAccountInfoAsync(
            Algorand.V2.Indexer.Model.Account accountInfo, Asset asset1, Asset asset2)
        {
        ...
        protected virtual async Task<Asset> FetchAssetFromApiAsync(ulong id)
        {
            ...
            var asset = await lookupApi.AssetsAsync(Convert.ToInt32(id), true);

            return new Asset
            {
                Id = (ulong)asset.Asset.Index,
