...
namespace Algorand
{
    ...
    public class Utils
    {
        ...
        public static async Task<V2.Algod.Model.PendingTransactionResponse> WaitTransactionToComplete(V2.Algod.IDefaultApi instance, string txID, ulong timeout = 3)
        {
        ...
        /// <param name="signedTx"></param>
        /// <returns></returns>
        public static async Task<V2.Algod.Model.PostTransactionsResponse> SubmitTransactions(V2.Algod.IDefaultApi instance, IEnumerable<SignedTransaction> signedTxs) //throws Exception
        {
